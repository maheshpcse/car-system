...
const CONTENT = {
  privacy: {
    title: 'Privacy',
    intro: 'Rekha Motors is a demonstration project. This page explains what the app stores and where.',
    sections: [
      ...
      { heading: 'What we do not do', body: 'No account data is sold. Fonts load from Google Fonts. Showroom maps load tiles from OpenStreetMap and CARTO. Email alerts in this demo stay in the browser.' },
